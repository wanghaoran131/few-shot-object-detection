...
json_file = PathManager.get_local_path("datasets/children_books/annotations/test_annotations.json")
gt_data = LVIS(json_file)
# print(type(data))
# print(data.anns)
# print(data.imgs)
# print(data.cats)
# print(data.dataset['categories'])
# print(data.dataset)

results = PathManager.get_local_path("/Users/whr/Documents/Thesis/few-shot-object-detection/checkpoints/children_books/faster_rcnn/faster_rcnn_R_101_FPN_base/inference/children_books_instances_predictions.json")
...
_evaluate_predictions_on_children_books(gt_data, results, "bbox")
